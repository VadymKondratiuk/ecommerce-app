...
* **Підтвердження (БД підключена — статус 200 OK та БД недоступна — статус 503 Service Unavailable):**
...
* **Підтвердження (Graceful Shutdown у логах):**
